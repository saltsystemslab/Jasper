...
INDEX="/tmp/deep100M-index" 
QUERIES="/projects/SaltSystemsLab/ann_data/deep/deep10kquery"
DATATYPE="float"
DIM="96"

GROUNDTRUTH="/projects/SaltSystemsLab/ann_gt/GT_100M/deep-100M"
DISTANCE="l2"
N_NEIGHBORS=64
...
LOG_BASE="$SCRIPT_DIR/results/query_deep100M"
